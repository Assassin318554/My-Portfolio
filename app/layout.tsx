...
export const metadata: Metadata = {
  title: { default: "Nahin Ahmed — CSE · Research & Teaching", template: "%s · Nahin Ahmed" },
  description:
    "Academic portfolio of Nahin Ahmed — CSE graduate interested in teaching, research, computer vision, human–computer interaction, and assistive technology.",
};
